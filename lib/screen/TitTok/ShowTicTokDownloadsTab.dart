...
class ShowTicTokDownloadsTabs extends StatefulWidget {
   final Directory dir, thumbDir;
 const ShowTicTokDownloadsTabs({this.dir, this.thumbDir});
 
  @override
  _ShowTicTokDownloadsTabsState createState() => _ShowTicTokDownloadsTabsState();
}

class _ShowTicTokDownloadsTabsState extends State<ShowTicTokDownloadsTabs> {
 List<bool> _isImage = [];
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (_isImage[index] == false) {
                String thumb = fileList[index].toString().replaceAll('File: \'/storage/emulated/0/${AppText.appName}/Tiktok/', '');
