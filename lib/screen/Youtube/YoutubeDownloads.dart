...
class YoutubeDownloads extends StatefulWidget {
   final Directory dir, thumbDir;
 const YoutubeDownloads({this.dir, this.thumbDir});
  @override
  _YoutubeDownloadsState createState() => _YoutubeDownloadsState();
}

class _YoutubeDownloadsState extends State<YoutubeDownloads> {
List<bool> _isImage = [];
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (_isImage[index] == false) {
                String thumb = fileList[index].toString().replaceAll('File: \'/storage/emulated/0/${AppText.appName}/Youtube/', '');
